...
protected:
  ...
  geometry_msgs::Twist::Ptr selectBestTwist(const geometry_msgs::Pose2D::Ptr& pose,
											const geometry_msgs::Twist::Ptr& twist, const Window& window);

  std::vector<geometry_msgs::Pose2D::Ptr> predictPath(const geometry_msgs::Pose2D::Ptr& pose,
													  const geometry_msgs::Twist::Ptr& next_twist);

  double evaluatePath(const geometry_msgs::Pose2D::Ptr& pose, const std::vector<geometry_msgs::Pose2D::Ptr>& path,
					  const geometry_msgs::Twist::Ptr& next_twist);
